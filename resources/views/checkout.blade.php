                        ...
                        <form action="/checkout" method="post">
                            @csrf
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="text" id="lastName" name="lastName" value="{{ old('lastName') }}" placeholder="Smith" required>
                                    @error('lastName')
                                    <span class="error-message">{{$message}}</span>                                        
                                    @enderror
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="creditCardNumber" id="creditCardNumber" name="creditCardNumber" placeholder="" value="{{ old('creditCardNumber') }}" required>
                                ...
                                <div class="form-row">
                                    ...
                                    <input type="nameOnCard" id="nameOnCard" name="nameOnCard" placeholder="John Smith" value="{{ old('nameOnCard') }}" required>
                                    @error('nameOnCard')
                                    <span class="error-message">{{$message}}</span>                                        
                                    @enderror
                                </div>
                                <div class="form-row">
                                    ...
                                    <input type="expiryDate" id="expiryDate" name="expiryDate" placeholder="" value="{{ old('expiryDate') }}" required>
                                    @error('expiryDate')
                                    <span class="error-message">{{$message}}</span>                                        
                                    @enderror
                                </div>
                                <div class="form-row">
                                    ...
                                    <input type="csv" id="csv" name="csv" placeholder="" value="{{ old('csv') }}" required>
                                    @error('csv')
                                    <span class="error-message">{{$message}}</span>                                        
                                    @enderror
                                </div>

                                {{-- //TODO show the items in the cart --}}
                                <p class="form-row">You have {{ $savedItems->count() }} items in your cart.</p>
