...
@section('content')
            ...
            <section class="site-main__section brand-partnerships">
                ...
                <div class="brand-partnerships-wrapper">
                    ...
                    <div class="brand-partnerships__imgs contact-form">
                        <div id="newsletter-form">
                            ...
                            <form action="{{ route('contactus.store') }}" method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <input class="form-input" type="text" id="firstName" name="firstName" value="{{ old('firstName') }}" required>
                                    @error('firstName')
                                ...
                                <div class="form-row">
                                    ...
                                    <input class="form-input" type="text" id="lastName" name="lastName" value="{{ old('lastName') }}" required>
                                    @error('lastName')
                                    <span class="error-message">{{$message}}</span>                                        
                                    @enderror
                                </div>
                                <div class="form-row">
                                    ...
                                    <input class="form-input" type="text" id="contactNumber" name="contactNumber" value="{{ old('contactNumber') }}">
                                    @error('contactNumber')
                                    <span class="error-message">{{$message}}</span>                                        
                                    @enderror
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <textarea class="form-input" name="question"
